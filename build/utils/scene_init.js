...
(function (ChangeOption) {
    ChangeOption[ChangeOption["rotx"] = 0] = "rotx";
    ChangeOption[ChangeOption["roty"] = 1] = "roty";
    ChangeOption[ChangeOption["rotz"] = 2] = "rotz";
    ChangeOption[ChangeOption["transx"] = 3] = "transx";
    ChangeOption[ChangeOption["transy"] = 4] = "transy";
    ChangeOption[ChangeOption["transz"] = 5] = "transz";
    ChangeOption[ChangeOption["scale"] = 6] = "scale";
...
export const createMoveDropdown = (objectWrapper, arena) => {
    ...
    optionDropdown.onchange = (e) => { if (e.target) {
...
//# sourceMappingURL=scene_init.js.map